         ...
         <div className="modifyPlaceContainer">
            <section>
               <form encType="multipart/form-data" className="place-form" onSubmit={handleSubmit}>
                  ...
                  <input className="form-input" type="text" name="name" defaultValue={name} onChange={handleChange} />
                  <label htmlFor="address">Adresse:</label>
                  <input className="form-input" type="text" name="address" defaultValue={address} onChange={handleChange} />
                  <label htmlFor="city">Code postal:</label>
                  <input className="form-input" type="number" name="zip_code" defaultValue={zip_code} onChange={handleChange} />
                  <label htmlFor="city">Ville:</label>
                  <input className="form-input" type="text" name="city" defaultValue={city} onChange={handleChange} />
                  <label htmlFor="description">Description:</label>
                  <textarea name="description" className="size-textarea" defaultValue={description} onChange={handleChange}></textarea>
